...
def validate_manifest(data, validator, error):
    ...
    encrypted = data['provider']['encrypted'] if 'encrypted' in data['provider'] else False
    kms_key_id = data['provider']['kms_key_id'] if 'kms_key_id' in data['provider'] else None
    ...
    if encrypted == False and kms_key_id != None:
